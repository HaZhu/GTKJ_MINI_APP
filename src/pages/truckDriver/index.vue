  ...
  <view class="container">
    ...
    <view class="header-section" :style="{ top: (44 + statusBarHeight) + 'px' }">
      ...
      <view v-if="active === 0" class="plate-notice">
        <view class="plate">当前车牌号：新<text style="font-weight: bold;">A22962D</text></view>
      ...
      <!-- 分页器 -->
      <view class="pager" v-if="active === 0 || active === 1 || active === 2 || active === 3">
        <text class="prev" @click="prev">上一页</text>
        <text class="center">第{{ page }}/{{ totalPage }}页, 共{{ total }}条</text>
